...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        primarySwatch: MaterialColor(0xFF044855, color),
      ),
      home: MyHomePage(),
    );
  }
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  static List<BottomNavigationBarItem> _navigationItems =
    ...
    BottomNavigationBarItem(
        ...
        label: "Riwayat"),
    BottomNavigationBarItem(
        icon: new Icon(Icons.notifications_none_outlined), label: "Notifikasi"),
    BottomNavigationBarItem(
        icon: new Icon(Icons.account_circle_outlined), label: "Profil"),
  ];
